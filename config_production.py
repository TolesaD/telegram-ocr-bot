...
# ==================== TEXT FORMATTING ====================
FORMAT_OPTIONS = [
    {'id': 'plain', 'name': '📄 Plain Text', 'description': 'Simple text format'},
    {'id': 'markdown', 'name': '📋 Markdown', 'description': 'Formatted text with Markdown'},
    {'id': 'html', 'name': '🌐 HTML', 'description': 'HTML formatted text'}
]
